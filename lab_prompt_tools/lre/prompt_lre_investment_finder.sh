...
QUERIES=(
  "ai startup investment themes 2026"
  "public market ai infrastructure opportunities"
  "high risk high reward technology sectors outlook"
  "portfolio risk management for concentrated investors"
  "behavioral finance overconfidence mitigation"
)
