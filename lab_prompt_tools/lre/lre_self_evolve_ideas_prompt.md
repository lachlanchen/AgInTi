# LRE Self-Evolve Prompt (Research Ideas / IDEAS)
...
4. improve idea quality for fast 7-day experiments and execution realism.
...
- include concrete changes to create/fix tools and improve search/click/find behavior.
