# LRE Self-Evolve Prompt (Books / LazyLearn)
...
4. improve recommendation quality for actionable 30-day reading and execution plans.
...
- include script/prompt changes that can create tool(s), fix tool(s), and organize tools cleanly.
